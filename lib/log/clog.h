...
#ifdef BUILDING_CLOG_DLL
#   define CLOG_EXPORT Q_DECL_EXPORT
#else
#   define CLOG_EXPORT 
#endif

class CLOG_EXPORT LoggChannel
{
protected:
	QString _chName;
public:
...
class CLOG_EXPORT FileLoggChannel: public LoggChannel
{	
public:
...
class CLOG_EXPORT _Log_ScopeTracer_
{	
    QString _msg;
