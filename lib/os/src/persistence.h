...
class OS_EXPORT Persistence : public QObject
{
Q_OBJECT
    Persistence(QObject *parent = 0);
    QMap<QString, int*> _intItems;
	QMap<QString, double*> _doubleItems;
...
public:
    ...
    bool declarePersistentItem( const QString &tag, int *member_var, QObject * containingObject=0 );
	bool declarePersistentItem( const QString &tag, double *member_var, QObject * containingObject=0 );
    bool declarePersistentItem( const QString &tag, QString *member_var, QObject * containingObject=0 );
